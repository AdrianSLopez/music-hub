    ...
    const content = props.publicRecommendations.map((rec, i) => {
        return (
            <div className="recommendations-item-container" key={rec._id}>
                <div onClick={onRecClick} data-index-songid={rec.songId} data-index-term={rec.userSearchTerm} data-offset={rec.offset} className={i===0? "recommendations-item-img-first":"recommendations-item-img"}><img  data-index-song={i} src={rec.albumImages[0].url} alt="album"/></div>
