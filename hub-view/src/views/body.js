...
export default function Body(props) {
  return (
      <div className="body">
        <Recommendations publicRecommendations={props.publicRecommendations} sendChosenSongId={props.sendChosenSongId} sendUserSearchTerm={props.sendUserSearchTerm} sendUrl={props.sendUrl} sendChosenAlbumId={props.sendChosenAlbumId} sendEndpointUsed={props.sendEndpointUsed}/>
