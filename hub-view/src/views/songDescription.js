...
export default function SongDescription(props) {
  ...
  return (
    <div className="songDescription-container">
        ...
        <Recommend chosenSongId={props.chosenSongId} songInfo={props.songInfo} userSearchTerm={props.userSearchTerm} current={props.current} endpointUsed={props.endpointUsed} chosenAlbumId={props.chosenAlbumId} chosenArtistId={props.chosenArtistId}/>        
    </div>
  );
}